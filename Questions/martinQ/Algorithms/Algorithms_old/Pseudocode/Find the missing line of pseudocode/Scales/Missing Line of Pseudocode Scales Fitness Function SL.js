...
var s = 0
myInput = 'Input: (S, W)';
myQuestionText='You are given the pseudocode for the Scales Fitness Function with one line missing. On the left hand side there are some lines of pseudocode. Find the missing line and move it into the pseudocode such that the pseudocode produces the desired output.<br> Here <b>S</b> is a binary string of length n, <b>W</b> is a real vector/array of weights of length n, and a value of <b>0</b> in <b>S</b> denotes a position on the left hand side.<br>To move a line, first click on a cell to selected it, then click on the desired location.';
myOutput="Output: |L-R|";
