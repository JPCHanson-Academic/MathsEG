...
myQuestionText='You are given the pseudocode for the Quick Sort Algorithm with one line missing. On the left hand side there are some lines of pseudocode. Find the missing line and move it into the pseudocode such that the pseudocode produces the desired output.<br>Here <b>list</b> is the set of elements to be ordered, <b>first</b> is the index of the first element, and <b>last</b> is the index of the last element.<br>To move a line, first click on a cell to selected it, then click on the desired location.';
...
var myTable = '<br><p>'+myQuestionText+'</p><br><center><table border="1" width="75%"> <tr> <th align="left"><font color="'+getBgColor()+'">.</font> </th> <th align="left";><font color="'+getFgColor()+'"><p style="font-size:'+getFontSize()+'">'+myInput+'</p></font></th></tr>';
