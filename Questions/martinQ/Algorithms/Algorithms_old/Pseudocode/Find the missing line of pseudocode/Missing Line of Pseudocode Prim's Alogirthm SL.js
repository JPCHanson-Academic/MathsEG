...
var myMyAnswersPlural = [
	...
	[["While Vnew &#8800 v"],["While Vnew &#8800 v"]],
	[["Chose an edge (u,v) with minimal weight, such that u &#8712 Vnew and v &#8713 Vnew"],["Chose an edge (u,v) with minimal weight, such that u &#8712 Vnew and v &#8713 Vnew"]],
	[["Vnew = Vnew &#8746 {v}, and Enew = Enew &#8746 {(u,v)}"],["Vnew = Vnew &#8746 {v}, and Enew = Enew &#8746 {(u,v)}"]],
	[["End while"]]
]
var myWrongsPlural = [
...
myInput = 'Input: (G, V, E)';
myQuestionText='You are given the pseudocode for Prim\'s Algorithm with one line missing. On the left hand side there are some lines of pseudocode. Find the missing line and move it into the pseudocode such that the pseudocode produces the desired output. Here <b>G</b> is a weighted graph with vertices <b>V</b>, and Edges <b>E</b>.<br>To move a line, first click on a cell to selected it, then click on the desired location.';
