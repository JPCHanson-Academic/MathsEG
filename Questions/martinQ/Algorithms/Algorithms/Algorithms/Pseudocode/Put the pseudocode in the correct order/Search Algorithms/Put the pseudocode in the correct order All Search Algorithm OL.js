...
function question1()
{
var sortSelection = Math.floor(Math.random()*5);
if (sortSelection == 0){//A* Algorithm 8 long
...
if (sortSelection == 1){//Deep First Search 8 long
var myMyAnswersPlural = [
	[["Visit(n), and Mark(n)"]],
...
if (sortSelection == 2){//Exhaustive Search 8 long
var myMyAnswersPlural = [
	[["For every edge nm (from n to m) in G do"]],
	[["If m &#8713 p then"]],
	[["p = p &#8746 {m}"]],
...
if (sortSelection == 3){//Floyd-Warshall 12 long
var myMyAnswersPlural = [
...
if (sortSelection == 4){//Prim's Algorithm 10 long
var myMyAnswersPlural = [
...
if (sortSelection == 3 || sortSelection == 4){
