...
<ANSWER QTYPE="RN" SHUFFLE="N">
<CHOICE ID="Choice">
<CONTENT WIDTH="40" TYPE="NULL"></CONTENT></CHOICE>
</ANSWER>
<OUTCOME ID="Correct" SCORE="1">
<CONDITION >"Choice" INCLUDES NOCASE "was Correct"</CONDITION><CONTENT TYPE="text/plain">Well done!</CONTENT></OUTCOME>
<OUTCOME ID="Wrong" SCORE="0">
<CONDITION >"Choice" INCLUDES NOCASE "was incorrect"</CONDITION><CONTENT TYPE="text/plain">You were wrong!</CONTENT></OUTCOME>
...
if (document.forms[0].name=="FEEDBACK")
	{
		...
		var titleofpopup = "Related material";
		var help = wheretolook("%QUESTION.TAGS%","%QUESTION.TOPIC%");
		document.write("<hr>"+"<input type='button' "+elementStyle("button", 15)
		+" name='Related material' size='30' value='Related material'"
		+" onClick='doMsg(help,titleofpopup)'>"+"<br>")
	}
</SCRIPT>