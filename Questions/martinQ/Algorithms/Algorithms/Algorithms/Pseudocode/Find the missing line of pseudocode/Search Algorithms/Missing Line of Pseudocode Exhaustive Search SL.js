...
var myMyAnswersPlural = [
	...
	[["If m &#8713 p then"],["If m &#8713 p then"]],
	[["p = p &#8746 {m}"],["p = p &#8746 {m}"]],
	[["Exhaustive(G, m, p)"],["Exhaustive(G, m, p)"]],
	[["End if"]],
	[["End for"]]
]
var myWrongsPlural = [
...
v = 3;
myInput = 'Input: (G, n, p)';
myQuestionText='You are given the pseudocode for the Exhaustive Search Algorithm with one line missing.<br> Here <b>G</b> is the graph, <b>n</b> is the current node, and <b>p</b> is the path so far. On the left hand side there are some lines of pseudocode. Find the missing line and move it into the pseudocode such that the pseudocode produces the desired output.<br>To move a line, first click on a cell to selected it, then click on the desired location.';
