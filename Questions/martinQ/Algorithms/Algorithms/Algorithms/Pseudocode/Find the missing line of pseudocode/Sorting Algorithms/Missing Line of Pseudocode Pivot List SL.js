...
myQuestionText='You are given the pseudocode for the Pivot List Algorithm with one line missing. On the left hand side there are some lines of pseudocode. Find the missing line and move it into the pseudocode such that the pseudocode produces the desired output.<br>Here <b>list</b> is the set of elements to be ordered, <b>first</b> is the index of the first element, and <b>last</b> is the index of the last element.<br>To move a line, first click on a cell to selected it, then click on the desired location.';
if (s == 0){	
