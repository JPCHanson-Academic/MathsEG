...
var myMyAnswersPlural = [
	...
	[["while |p| > 0"],["while |p| > 0"]],
	[["Let i = UI(1,|p|)"]],
	[["Add P<sub>i</sub> to the end of T"],["Add P<sub>i</sub> to the end of T"]],
	[["Delete the ith element (P<sub>i</sub> from P)"],["Delete the ith element (P<sub>i</sub> from P)"]],
	[["End while"]]
	]
var myWrongsPlural = [
	[["while |p| = 0"]],
...
v = 4;
myInput = 'Input: N';
myQuestionText='You are given the pseudocode for the RandPerm Algorithm for the TSP with one line missing. On the left hand side there are some lines of pseudocode. Here <b>N</b> is the number of cities. Find the missing line and move it into the pseudocode such that the pseudocode produces the desired output.<br>To move a line, first click on a cell to selected it, then click on the desired location.';
