...
var myMyAnswersPlural = [
	...
	[["Let f = fitness of x"],["Let f = fitness of x"]],
	[["Make a small change to x to make x'"]],
	[["Let f' = fitness of new point x'"],["Let f' = fitness of new point x'"]],
	[["If f' is worse than f then"]],
	[["Let p = pr(f',f,T<sub>i</sub>)"]],
	[["If p < UR(0,1) Then"],["If p < UR(0,1) Then"]],
	[["Keep x and f"],["Keep x and f"]],
	[["Else"]],
	[["Keep x' and f'"],["Keep x' and f'"]],
	[["End if"]],
	[["Else"]],
...
myQuestionText='You are given the pseudocode for the Simulated Annealing Algorithm with one line missing. On the left hand side there are some lines of pseudocode. Find the missing line and move it into the pseudocode such that the pseudocode produces the desired output.<br> Here <b>PR(f\',f,T<sub>i</sub>)</b> = exp(-&#916f/T<sub>i</sub>) where <nobr>&#916f = |f-f\'|</nobr>, <b>T<sub>0</sub></b> is the starting temperature, <b>Iter</b> is the number of iterations, and <b>&#955</b> is the cooling rate. <br>To move a line, first click on a cell to selected it, then click on the desired location.';
...
document.getElementById(myLocation[32]).onclick = function() {selecting(34)};
