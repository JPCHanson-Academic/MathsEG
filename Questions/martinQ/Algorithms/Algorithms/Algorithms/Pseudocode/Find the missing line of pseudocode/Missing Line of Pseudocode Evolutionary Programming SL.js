...
var myMyAnswersPlural = [
	...
	[["Mutate the population"],["Mutate the population"]],
	[["Apply Tournament Selection"],["Apply Tournament Selection"]],
	[["End for"]]
]
...
myQuestionText='You are given the pseudocode for an Evolutionary Programming Algorithm with one line missing.<br>Here <b>population size</b> is the size of the population, <b>number of generations</b> is how many generations the population will go through, and <b>fitness function</b> is the fitness funciton. On the left hand side there are some lines of pseudocode. Find the missing line and move it into the pseudocode such that the pseudocode produces the desired output.<br>To move a line, first click on a cell to selected it, then click on the desired location.';
