...
var myMyAnswersPlural = [
	...
	[["Let S<sub>i</sub> = |Random Integer| mod 2"],["Let S<sub>i</sub> = |Random Integer| mod 2"]],
	[["end for"]]
]
var myWrongsPlural = [
...
v = 4;
myInput = 'Input: n';
myQuestionText='You are given the pseudocode for the RandomStart Algorithm for the Scales Problem with one line missing. On the left hand side there are some lines of pseudocode. Here <b>n</b> is the number of weights. Find the missing line and move it into the pseudocode such that the pseudocode produces the desired output.<br>To move a line, first click on a cell to selected it, then click on the desired location.';
